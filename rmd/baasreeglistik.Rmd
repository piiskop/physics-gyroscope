...
```{=tex}
\begin{align}
I = \sum{\frac{\vec{p}}{\vec{v}} \times r^2} = \sum{\frac{\vec{p}}{\vec{\omega \times r}} \times r^2} \\ = \sum{\frac{\vec{\frac{\vec{L}}{\vec{r}}}}{\vec{\omega \times r}} \times r^2} = \frac{\sum{\vec{L}}}{\vec{\omega}}.
...
```{=tex}
\begin{align}
\vec{T} = \vec{\frac{\mathrm{d({\vec{L}})}}{\vec{\omega}}} \times \vec{\frac{\mathrm{d}(\omega)}{\mathrm{d}(t)}} = \frac{\mathrm{d}({\vec{L}})}{\mathrm{d}(t)}.
